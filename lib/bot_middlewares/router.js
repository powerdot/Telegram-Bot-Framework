...
exports.default = (function (_a) {
    var db = _a.db, components = _a.components;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        step_ = _c.sent();
                        parseCallbackPath = helpers.parseCallbackPath(ctx);
                        parseStep = false;
                        if (step_) {
                            parseStep = {
                                route: step_.split("�")[0],
                        ...
                        if (!parseCallbackPath) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        if (routing.component) {
                            ...
                            if (component) {
                                ...
                                console.log("\uD83D\uDC94 Component with ID ".concat(routing.component, " not found."));
                            }
                        }
