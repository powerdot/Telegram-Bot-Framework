...
exports.default = (function (bot, _a, config) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, collection_UserData.findOne({ chatId: chatId, name: key })];
                    case 1:
                        data = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        chatId = getChatId(ctx);
                        return [4 /*yield*/, collection_UserData.updateOne({ name: key, chatId: chatId }, { $set: { name: key, chatId: chatId, value: value } }, { upsert: true })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        chatId = getChatId(ctx);
                        return [4 /*yield*/, collection_UserData.deleteOne({ name: key, chatId: chatId })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    function userCollection(ctx, collection_name) {
        var chatId = getChatId(ctx);
        return {
            find: function (query) {
                if (query === void 0) { query = {}; }
                return collection_UserDataCollection.findOne(__assign({ collection_name: collection_name, chatId: chatId }, parseQuery(query)));
            },
            findAll: function (query) {
                if (query === void 0) { query = {}; }
                return collection_UserDataCollection.find(__assign({ collection_name: collection_name, chatId: chatId }, parseQuery(query))).toArray();
            },
            insert: function (value) {
                return collection_UserDataCollection.insertOne(__assign({ collection_name: collection_name, chatId: chatId }, value));
            },
            update: function (query, value) {
                return collection_UserDataCollection.updateOne(__assign({ collection_name: collection_name, chatId: chatId }, parseQuery(query)), { $set: value });
            },
            updateMany: function (query, value) {
                return collection_UserDataCollection.updateMany(__assign({ collection_name: collection_name, chatId: chatId }, parseQuery(query)), { $set: value });
            },
            delete: function (query) {
                return collection_UserDataCollection.deleteOne(__assign({ collection_name: collection_name, chatId: chatId }, parseQuery(query)));
            },
            deleteMany: function (query) {
                return collection_UserDataCollection.deleteMany(__assign({ collection_name: collection_name, chatId: chatId }, parseQuery(query)));
            }
        };
    }
    function removeMessages(ctx, onlyTrash, removeSpecialCommands) {
        if (removeSpecialCommands === void 0) { removeSpecialCommands = false; }
        return __awaiter(this, void 0, void 0, function () {
            var chatId, query, queryTrash, currentBotMessagesToRemove, _i, currentBotMessagesToRemove_1, currentMessageToRemove, messageId, currentUserMessagesToRemove, _a, currentUserMessagesToRemove_1, currentMessageToRemove, messageId, currentSpecialCommandsToRemove, _b, currentSpecialCommandsToRemove_1, currentMessageToRemove, messageId;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        currentBotMessagesToRemove = _c.sent();
                        if (config.debug)
                    ...
                    case 4:
                        currentUserMessagesToRemove = _c.sent();
                        if (config.debug)
                        ...
                        if (!(removeSpecialCommands && !onlyTrash)) return [3 /*break*/, 7];
                        return [4 /*yield*/, collection_specialCommandsHistory.find(query)];
                    case 5: return [4 /*yield*/, (_c.sent()).toArray()];
                    case 6:
                        currentSpecialCommandsToRemove = _c.sent();
                        if (config.debug)
                        ...
                        if (currentSpecialCommandsToRemove.length != 0) {
                            for (_b = 0, currentSpecialCommandsToRemove_1 = currentSpecialCommandsToRemove; _b < currentSpecialCommandsToRemove_1.length; _b++) {
                                currentMessageToRemove = currentSpecialCommandsToRemove_1[_b];
                                messageId = currentMessageToRemove === null || currentMessageToRemove === void 0 ? void 0 : currentMessageToRemove.messageId;
                                if (!messageId)
                                    continue;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        selectedCollection = ((_a = message === null || message === void 0 ? void 0 : message.from) === null || _a === void 0 ? void 0 : _a.is_bot) ? collection_BotMessageHistory : collection_UserMessageHistory;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        chatId = getChatId(ctx);
                        return [4 /*yield*/, _UserDataDestroy(ctx)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, collection_Users.deleteMany({ chatId: chatId })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, collection_UserMessageHistory.deleteMany({ chatId: chatId })];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, collection_BotMessageHistory.deleteMany({ chatId: chatId })];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        chatId = getChatId(ctx);
                        return [4 /*yield*/, collection_UserData.deleteMany({ chatId: chatId })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, collection_UserDataCollection.deleteMany({ chatId: chatId })];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, collection_TempData.deleteMany({ chatId: chatId })];
                    case 3:
                        _a.sent();
     ...
     * @param {*} unix_lim
     */
    function findOldMessages(unix_lim, withSpecialCommands) {
        if (withSpecialCommands === void 0) { withSpecialCommands = false; }
        return __awaiter(this, void 0, void 0, function () {
            var b, u, uc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        b = _a.sent();
                        return [4 /*yield*/, collection_UserMessageHistory.find({ "message.date": { $lte: unix_lim } }).toArray()];
                    case 2:
                        u = _a.sent();
                        uc = [];
                        if (!withSpecialCommands) return [3 /*break*/, 4];
                        return [4 /*yield*/, collection_specialCommandsHistory.find({ "message.date": { $lte: unix_lim } }).toArray()];
                    case 3:
                        uc = _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/, __spreadArray(__spreadArray(__spreadArray([], b, true), u, true), uc, true)];
                }
            });
        });
    }
