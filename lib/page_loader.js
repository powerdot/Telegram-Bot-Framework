    ...
    var _loop_1 = function (page) {
        ...
        var binding = {
            ...
            send: function (_a) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var _this, options, inline_buttons, reply_keyboard, message, error_1;
            ...
            update: function (_a) {
                var _b = _a.text, text = _b === void 0 ? "" : _b, _c = _a.buttons, buttons = _c === void 0 ? [] : _c, _d = _a.keyboard, keyboard = _d === void 0 ? [] : _d;
                return __awaiter(this, void 0, void 0, function () {
                    var options, inline_buttons, reply_keyboard, lastBotMessage, edited, e_1, error_2;
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                if (text === undefined)
                            ...
                            case 4:
                                _e.trys.push([4, 9, , 10]);
                                if (!this.ctx.routing.isMessageFromUser) return [3 /*break*/, 8];
                                return [4 /*yield*/, db.messages.bot.getLastMessage(this.ctx)];
                            case 5:
                                lastBotMessage = _e.sent();
                                if (!lastBotMessage) return [3 /*break*/, 8];
                                if (config.debug)
                            ...
                            case 6:
                                edited = _e.sent();
                                return [4 /*yield*/, db.messages.removeMessages(this.ctx, true)];
                            case 7:
                                _e.sent();
                            ...
                            case 10:
                                ...
                                return [4 /*yield*/, this.ctx.editMessageText(text, __assign(__assign({}, options), { parse_mode: 'HTML' }))];
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            ...
                            case 1:
                                _d.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, removeMessageWrapper.bind(this)('sendMediaGroup', [media, options])];
                            case 2: return [2 /*return*/, _d.sent()];
                            case 3:
                                error_3 = _d.sent();
                                console.error("sendMediaGroup error", error_3);
                                return [2 /*return*/, null];
            ...
            goToComponent: function (_a) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var _this, found_component, action_fn, error_4;
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                if (!type)
                                ...
                                if (!found_component) return [3 /*break*/, 6];
                            ...
                            case 2:
                                _d.trys.push([2, 4, , 5]);
                                return [4 /*yield*/, action_fn.bind(__assign(__assign({}, _this), { id: component }))({ ctx: _this.ctx, data: data })];
                            case 3: return [2 /*return*/, _d.sent()];
                            case 4:
                                error_4 = _d.sent();
                                console.error("goToComponent error", error_4);
                                return [2 /*return*/, null];
                            case 5: return [3 /*break*/, 7];
                            case 6: throw new Error("goToComponent() component not found: " + component);
            ...
            goToPage: function (_a) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, this.goToComponent({ component: page, action: action, data: data, type: "page" })];
            ...
            goToPlugin: function (_a) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0: return [4 /*yield*/, this.goToComponent({ component: plugin, action: action, data: data, type: "plugin" })];
                            case 1: return [2 /*return*/, _c.sent()];
                        }
                    });
                });
            ...
            goToAction: function (_a) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var _this, current_page, page_action, action_fn, error_5;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _this = this;
                                ...
                                if (!page_action) return [3 /*break*/, 6];
                            ...
                            case 2:
                                _b.trys.push([2, 4, , 5]);
                                return [4 /*yield*/, action_fn.bind(__assign(__assign({}, _this), { id: _this.id }))({ ctx: _this.ctx, data: data })];
                            case 3: return [2 /*return*/, _b.sent()];
                            case 4:
                                error_5 = _b.sent();
                                console.error("goToAction error", error_5);
                                return [2 /*return*/, null];
                            case 5: return [3 /*break*/, 7];
                            case 6: throw new Error("goToAction() action not found: " + action);
                            case 7: return [2 /*return*/];
                        }
                    });
                });
            ...
            user: function () {
                ...
                return {
                    ...
                    getValue: function (key) { return __awaiter(_this_1, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, db.getValue(_this.ctx, key)];
                    }); }); },
                    setValue: function (key, value) { return __awaiter(_this_1, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, db.setValue(_this.ctx, key, value)];
                    }); }); },
                    removeValue: function (key) { return __awaiter(_this_1, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, db.removeValue(_this.ctx, key)];
                    }); }); },
                    destroy: function () { return __awaiter(_this_1, void 0, void 0, function () { return __generator(this, function (_a) {
                        return [2 /*return*/, db.user.destroy(_this.ctx.chatId)];
                    }); }); },
                    collection: db.user.collection(_this.ctx, String(_this.ctx.chatId)),
                };
            },
            userMethods: function (_a) {
                var user_id = _a.user_id;
                return __awaiter(this, void 0, void 0, function () {
                    var _this, userBinding, lastUserFrom, ctx;
                    var _this_1 = this;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _this = this;
                                return [4 /*yield*/, db.getValue(user_id, "from")];
                            case 1:
                                lastUserFrom = _b.sent();
                                ctx = __assign(__assign({}, _this.ctx), { update: undefined, telegram: _this.ctx.telegram, from: lastUserFrom });
                                if (ctx.chatId)
                                    ctx.chatId = user_id;
                                if (ctx.chat)
                                    ctx.chat.id = user_id;
                                userBinding = __assign(__assign({}, binding), { ctx: ctx });
                                return [2 /*return*/, {
                                        send: function (args) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.send.bind(userBinding)(args)];
                                                });
                                            });
                                        },
                                        update: function (args) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.update.bind(userBinding)(args)];
                                                });
                                            });
                                        },
                                        goToPage: function (args) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.goToPage.bind(userBinding)(args)];
                                                });
                                            });
                                        },
                                        goToPlugin: function (args) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.goToPlugin.bind(userBinding)(args)];
                                                });
                                            });
                                        },
                                        goToAction: function (args) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.goToAction.bind(userBinding)(args)];
                                                });
                                            });
                                        },
                                        goToComponent: function (args) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.goToComponent.bind(userBinding)(args)];
                                                });
                                            });
                                        },
                                        clearChat: function () {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.clearChat.bind(userBinding)()];
                                                });
                                            });
                                        },
                                        sendMediaGroup: function (args) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    return [2 /*return*/, binding.sendMediaGroup.bind(userBinding)(args)];
                                                });
                                            });
                                        },
                                        getCurrentRoute: function () { return __awaiter(_this_1, void 0, void 0, function () {
                                            var step, _a, page, action;
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    case 0: return [4 /*yield*/, db.getValue(user_id, "step")];
                                                    case 1:
                                                        step = _b.sent();
                                                        _a = step.split("�"), page = _a[0], action = _a[1];
                                                        return [2 /*return*/, { page: page, action: action }];
                                                }
                                            });
                                        }); }
                                    }];
        ...
        if (!pageObject.onCallbackQuery) {
            pageObject.onCallbackQuery = function (ctx) { return __awaiter(_this_1, void 0, void 0, function () {
                var ctx_action, action, action_fn, error_6;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            pageObject.ctx = ctx;
                        ...
                        case 8:
                            error_6 = _a.sent();
                            console.error("onCallbackQuery ERROR ON PAGE \"".concat(pageObject.id, "\":"), error_6);
                            return [3 /*break*/, 9];
        ...
        if (!pageObject.onMessage) {
            pageObject.onMessage = function (ctx) { return __awaiter(_this_1, void 0, void 0, function () {
                var action, handler, handler_fn, result, error_7;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 3:
                            ...
                            _a.label = 4;
                        case 4:
                            if (!ctx.from) return [3 /*break*/, 6];
                            return [4 /*yield*/, db.setValue(ctx, "from", ctx.from)];
                        case 5:
                            _a.sent();
                            _a.label = 6;
                        case 6:
                        ...
                        case 7:
                            result = _a.sent();
                            if (!(typeof result === "boolean")) return [3 /*break*/, 9];
                        ...
                        case 9:
                            ...
                            return [3 /*break*/, 12];
                        case 10: return [4 /*yield*/, db.messages.removeMessages(ctx, true)];
                        case 11:
                            _a.sent();
                            _a.label = 12;
                        ...
                        case 13:
                            error_7 = _a.sent();
                            console.error("onMessage ERROR ON PAGE \"".concat(pageObject.id, "\":"), error_7);
                            return [3 /*break*/, 14];
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 3:
                                _b.sent();
                                return [4 /*yield*/, db.setValue(ctx, "step", pageObject.id + "�" + act)];
                            case 4:
                                _b.sent();
