...
function loader(_a) {
    ...
    var _loop_1 = function (page) {
        ...
        if (!pageObject.open)
            pageObject.open = function (ctx) {
                return __awaiter(this, void 0, void 0, function () {
                    var action_fn;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                action_fn = extractHandler(pageObject.actions.main);
                                return [4 /*yield*/, db.messages.removeMessages(ctx)];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, action_fn.bind(__assign(__assign({}, binding), { ctx: ctx }))({ ctx: ctx })];
                            case 2:
                                _a.sent();
...
exports.default = (function (_a) {
    ...
    var paginator = require("./paginator")({ config: config });
