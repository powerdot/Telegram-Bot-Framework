...
var Create = function (_a) {
    ...
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            require("../src/startup_chain")({ webServer: webServer, telegram: telegram, mongo: mongo, config: _config }).then(function (_a) {
                ...
                return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                db = require("../src/helpers/db")(bot, database);
                                _b = require("../src/page_loader")({ db: db, config: _config }), pages = _b.pages, plugins = _b.plugins;
                                ...
                                bot.use(require("../src/bot_middlewares/mark_user_messages")({ db: db }));
                                return_data = {
                                    bot: bot,
                                    app: app,
                                    database: database,
                            ...
                            case 1:
                                ...
                                if (config.autoRemoveMessages)
                                    require("../src/auto_remove_messages")({ db: db });
                                // Engine router
                                bot.use(require("../src/bot_middlewares/router")({ db: db, components: components }));
                                // Starting web server
