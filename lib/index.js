...
exports.Component = exports.TBF = void 0;
            ...
            (0, startup_chain_1.default)({ webServer: webServer, telegram: telegram, mongo: mongo, config: _config }).then(function (_a) {
                ...
                return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_c) {
                        switch (_c.label) {
                            case 0:
                                db = (0, db_1.default)(bot, database, _config);
                                ...
                                return_data = {
                                    ...
                                    openPage: function (_a) {
                                        var ctx = _a.ctx, page = _a.page, data = _a.data, _b = _a.action, action = _b === void 0 ? "main" : _b;
                                        return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                                            var found_page;
                                            return __generator(this, function (_a) {
                                                found_page = components.find(function (p) { return p.id === page; });
                                                if (!found_page)
                                                    return [2 /*return*/, reject(new Error("Component not found: " + page))];
                                                if (found_page.open)
                                                    found_page.open({ ctx: ctx, data: data, action: action });
                            ...
                            case 1:
                                ...
                                // Engine router
                                bot.use((0, router_1.default)({ db: db, components: components, config: _config }));
                                // Starting web server
                                if (app && (webServer === null || webServer === void 0 ? void 0 : webServer.module))
                                    app.use(webServer.module({ bot: bot, db: db, config: _config, components: components, database: database }));
                                return [2 /*return*/];
                        }
                    });
                });
