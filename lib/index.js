...
let Create = ({ webServer, telegram, storage, mongo, config }) => {
    let cwd = process.cwd();
    let default_config = {
        pages: {
    ...
    return new Promise(async (resolve, reject) => {
        (0, startup_chain_1.default)({ webServer, telegram, storage, mongo, config: _config }).then(async ({ bot, app, database }) => {
